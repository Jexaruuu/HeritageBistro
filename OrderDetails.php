...
include ('OrderDetailsInclude/header.php');
    ...
    <div class="receipt">
        ...
        <div>
                ...
                <tbody>
                    <?php foreach ($order['order_details'] as $detail) { ?>
                        <tr>
                            ...
                            <td class="menu-price-column"><p>₱<?php echo number_format($detail['price'], 2); ?></p></td>
                            <td class="menu-QTY-column"><?php echo $detail['quantity']; ?></td>
                            <td><p>₱<?php echo number_format($detail['subtotal'], 2); ?></p></td>
            ...
            <div class="two-div-receipt">
                <div class="left-receipt-coloumn"></div>
